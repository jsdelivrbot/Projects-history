import { TaxCodesTab } from 'containers/Settings/System/Taxes/Tabs/CategoriesTab/CategoriesTab';
...
describe('TaxCodesTab', () => {
  const props = {
    ...
    taxCategoriesSaveRequest: jest.fn(),
    taxCategoriesUpdateRequest: jest.fn(),
    taxCategoriesDeleteRequest: jest.fn()
  };
